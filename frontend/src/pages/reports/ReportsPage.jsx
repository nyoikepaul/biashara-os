...
import { BarChart3, Plus, Search, RefreshCw, Download, Filter } from 'lucide-react'
...
export default function ReportsPage() {
  ...
  const tabs = [{"id":"overview","label":"Overview"},{"id":"sales","label":"Sales Analytics"},{"id":"inventory","label":"Stock Valuation"},{"id":"payroll","label":"Payroll Summary"},{"id":"vat","label":"VAT Return"}]
 
  return (
    <div className="space-y-6">
      <PageHeader
        title={<span className="flex items-center gap-2"><BarChart3 size={22} className="text-purple-600"/>Reports & Analytics</span>}
        subtitle="Manage your reports workflows"
        actions={<>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm">
        ...
        {loading ? (
          ...
          <EmptyState icon={BarChart3} title="No reports records yet" subtitle="Get started by adding your first record" action={<button className="btn-primary btn-sm">+ Add Reports</button>} />
        ) : (
          <div className="p-5">
